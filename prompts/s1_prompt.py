...
V(验证): 操作被拒绝，[dependent_entity].[dependent_dimension]状态保持为操作前状态并给出禁止提示
         ref_to非null → 标注"此条件已在[ref_to.obligation_id]前置条件中体现，若条件满足则操作被允许"
...
## Procedure Schema (BDD: Given-When-Then)
```json
{
  "temp_id": "PROC-T{N}",
  "source_ids": [],
  ...
  "operation_hints": ["导航至XX页面", "点击XX按钮"],
  "gen_seq": 1,
  "post_state": "",
  "cascade_chain": null,
  "br_embedded": [],
