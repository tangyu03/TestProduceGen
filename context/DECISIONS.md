...
- 基线（未补门禁）E-XM={0,1,2,3,4} 与改动前一致；补门禁后={0,1,2,5,6}；E-PJ/E-YP/E-JFTZ 相位零变化（全局与 per-branch 双视图均验证）；
- 报告审核中=5 > 结果已提交=4 → 068~070 排到 074~077 后；与评价中=5 同相位时按 topology_level tiebreak（E-PJ=0 < E-XM=2）→ 082~085 仍在 068~070 前；
- PROC-070 stage_hint（EO-CRU-009 锚 E-XM.项目状态.报告审核中）自动随 dep_state_phase_map 升到 P5；
- pytest 21 passed。
