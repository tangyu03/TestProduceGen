...
def build() -> DomainModel:
    ...
    m.add_trans(
        ...
        role="二级审批员",
        preconditions=[
            precond(text="导入任务处于待二级审批状态", ptype="state_ref",
                    ref=state_ref("E-IMP", "任务状态", "待二级审批")),
            precond(text="任务级别为C级", ptype="constraint", ref=None),
        ],
        expected_results=["若任务级别=C级，则二级审批员通过后审批通过后导入申请人可进行文件的导入；任务状态变为审批通过"],
        traits=["branch"],
        direction="forward", priority="P0",
        source_ref="4.5.2",
        note={"branch_dimension": "任务级别",
              "comment": "direction: 待二级审批在 states 先于审批通过，判 forward；C级二级审批通过路径；二级审批员在 transitions 层的出现点"},
    )
    m.add_trans(
        tid="t03b",
        entity="E-IMP", dimension="任务状态",
        ...
        expected_results=["若任务级别=C级且二级审批员拒绝，则导入任务终止；导入申请人需重新提交导入任务"],
        traits=["branch"],
    ...
    m.add_trans(
        ...
        role="二级审批员",
        preconditions=[
            precond(text="登记任务处于待二级审批状态", ptype="state_ref",
                    ref=state_ref("E-REG", "任务状态", "待二级审批")),
            precond(text="任务级别为C级", ptype="constraint", ref=None),
        ],
        expected_results=["若任务级别=C级，则二级审批员通过后审批通过后登记申请人可看到载体已经登记入个人台账；任务状态变为审批通过"],
        traits=["branch"],
        direction="forward", priority="P0",
        source_ref="4.6.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        expected_results=["若任务级别=C级且二级审批员拒绝，则登记任务终止；登记申请人需重新提交登记任务"],
        traits=["branch"],
        direction="lateral", priority="P1",
        source_ref="4.6.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        role="二级审批员",
        preconditions=[
            precond(text="归档任务处于待二级审批状态", ptype="state_ref",
                    ref=state_ref("E-ARC", "任务状态", "待二级审批")),
            precond(text="任务级别为C级", ptype="constraint", ref=None),
        ],
        expected_results=["若任务级别=C级，则二级审批员通过后审批通过后归档申请人需将载体交到载体管理员处；任务状态变为审批通过"],
        traits=["branch"],
        direction="forward", priority="P0",
        source_ref="4.7.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        expected_results=["若任务级别=C级且二级审批员拒绝，则归档任务终止；归档申请人需重新提交归档任务"],
        traits=["branch"],
        direction="lateral", priority="P1",
        source_ref="4.7.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        role="二级审批员",
        preconditions=[
            precond(text="移交任务处于待二级审批状态", ptype="state_ref",
                    ref=state_ref("E-TRF", "任务状态", "待二级审批")),
            precond(text="任务级别为C级", ptype="constraint", ref=None),
        ],
        expected_results=["若任务级别=C级，则二级审批员通过后审批通过后移交申请人需和接收人完成交接；任务状态变为审批通过"],
        traits=["branch"],
        direction="forward", priority="P0",
        source_ref="4.8.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        expected_results=["若任务级别=C级且二级审批员拒绝，则移交任务终止；移交申请人需重新提交移交任务"],
        traits=["branch"],
        direction="lateral", priority="P1",
        source_ref="4.8.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        role="二级审批员",
        preconditions=[
            precond(text="留存任务处于待二级审批状态", ptype="state_ref",
                    ref=state_ref("E-RET", "任务状态", "待二级审批")),
            precond(text="任务级别为C级", ptype="constraint", ref=None),
        ],
        expected_results=["若任务级别=C级，则二级审批员通过后审批通过后载体持有时间自动增加；任务状态变为审批通过"],
        traits=["branch"],
        direction="forward", priority="P0",
        source_ref="4.9.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        expected_results=["若任务级别=C级且二级审批员拒绝，则留存任务终止；留存申请人需重新提交留存任务"],
        traits=["branch"],
        direction="lateral", priority="P1",
        source_ref="4.9.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        role="二级审批员",
        preconditions=[
            precond(text="回收任务处于待二级审批状态", ptype="state_ref",
                    ref=state_ref("E-RCY", "任务状态", "待二级审批")),
            precond(text="任务级别为C级", ptype="constraint", ref=None),
        ],
        expected_results=["若任务级别=C级，则二级审批员通过后审批通过后回收申请人将载体移交给载体管理员进行回收；任务状态变为审批通过"],
        traits=["branch"],
        direction="forward", priority="P0",
        source_ref="4.10.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        expected_results=["若任务级别=C级且二级审批员拒绝，则回收任务终止；回收申请人需重新提交回收任务"],
        traits=["branch"],
        direction="lateral", priority="P1",
        source_ref="4.10.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        role="二级审批员",
        preconditions=[
            precond(text="外送任务处于待二级审批状态", ptype="state_ref",
                    ref=state_ref("E-OUT", "任务状态", "待二级审批")),
            precond(text="任务级别为C级", ptype="constraint", ref=None),
        ],
        expected_results=["若任务级别=C级，则二级审批员通过后审批通过后外送申请人需打印载体外送交接单并将回执交给载体管理员；任务状态变为审批通过"],
        traits=["branch"],
        direction="forward", priority="P0",
        source_ref="4.11.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        expected_results=["若任务级别=C级且二级审批员拒绝，则外送任务终止；外送申请人需重新提交载体外送任务"],
        traits=["branch"],
        direction="lateral", priority="P1",
        source_ref="4.11.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        role="二级审批员",
        preconditions=[
            precond(text="导出任务处于待二级审批状态", ptype="state_ref",
                    ref=state_ref("E-EXP", "任务状态", "待二级审批")),
            precond(text="任务级别为C级", ptype="constraint", ref=None),
        ],
        expected_results=["若任务级别=C级，则二级审批员通过后审批通过后导出申请人可进行载体的导出；任务状态变为审批通过"],
        traits=["branch"],
        direction="forward", priority="P0",
        source_ref="4.12.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        expected_results=["若任务级别=C级且二级审批员拒绝，则导出任务终止；导出申请人需重新提交导出任务"],
        traits=["branch"],
        direction="lateral", priority="P1",
        source_ref="4.12.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        role="二级审批员",
        preconditions=[
            precond(text="扫描任务处于待二级审批状态", ptype="state_ref",
                    ref=state_ref("E-SCN", "任务状态", "待二级审批")),
            precond(text="任务级别为C级", ptype="constraint", ref=None),
        ],
        expected_results=["若任务级别=C级，则二级审批员通过后审批通过后扫描申请人可进行文件的扫描；任务状态变为审批通过"],
        traits=["branch"],
        direction="forward", priority="P0",
        source_ref="4.13.2",
        note={"branch_dimension": "任务级别",
    ...
    m.add_trans(
        ...
        expected_results=["若任务级别=C级且二级审批员拒绝，则扫描任务终止；扫描申请人需重新提交扫描任务"],
        traits=["branch"],
        direction="lateral", priority="P1",
        source_ref="4.13.2",
        note={"branch_dimension": "任务级别",
